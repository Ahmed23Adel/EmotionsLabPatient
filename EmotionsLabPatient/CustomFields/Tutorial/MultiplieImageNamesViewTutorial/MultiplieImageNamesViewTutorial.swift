...
struct MultiplieImageNamesViewTutorial: View {
    @Binding var emotionNames: [String: [SingleImageName]]
    @StateObject private var viewModel = MultiplieImageNamesTutorialViewModel()
        ...
        var body: some View {
            HStack(alignment: .center, spacing: 0) {
                ...
                ForEach(imageNames.indices, id: \.self) { colIndex in
                    SingleImageNameWithAnimationViewTutorial(currentSingleName: imageNames[colIndex], selectCurrentNameParentFunc: selectCurrentNameParentFunc)
...
#Preview {
    ...
    MultiplieImageNamesViewTutorial(emotionNames: $emotionNames, selectCurrentNameParentFunc: dummyFunc)
}
